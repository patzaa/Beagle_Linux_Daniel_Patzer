...
while playGame:
        #Compare the current encoder values with the previous values. If the values are different, change the i2c data for the matrix accordingly
                ...
                time.sleep(0.3)
                e2=Encoder1.position
                e3=Encoder2.position
                if e2<currentEncoder2:
                        ...
                        if yPos!=8:
                                ...
                                board[currentIndex]=board[currentIndex] | map[yPos] #Or the correct binary value with the i2c data to changing vertical position and keep your trail
                                bus.write_i2c_block_data(matrix, 0, board)
