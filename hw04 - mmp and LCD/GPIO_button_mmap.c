//This program uses the GPIO1 and GPIO3 registers together with mmap() to detect two button presses and light up the two internal LEDs
...
gpio1_addr = mmap(0, GPIO1_SIZE, PROT_READ | PROT_WRITE, MAP_SHARED, fd, GPIO1_$
gpio3_addr = mmap(0, GPIO3_SIZE, PROT_READ | PROT_WRITE, MAP_SHARED, fd, GPIO3_$
